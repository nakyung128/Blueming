...
extension Alert {
    static var data = [
        ...
        Alert(date: "2023-10-20", title: "오늘의 키워드가 아직 완성되지 않았어요!", script: "오늘의 키워드를 완성하면 맞춤형 체크리스트를 제공받을 수 있어요.", isRead: false, vc: "TabBarVC"),
        Alert(date: "2023-10-23", title: "오늘은 자가진단을 하는 날이에요:)", script: "일주일간 나의 변화를 살펴봐요!", isRead: false, vc: "TestVC"),
        Alert(date: "2023-10-24", title: "오늘의 키워드가 아직 완성되지 않았어요!", script: "오늘의 키워드를 완성하면 맞춤형 체크리스트를 제공받을 수 있어요.", isRead: false, vc: "TabBarVC")
    ]
}
